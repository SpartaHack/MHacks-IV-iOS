...
#import "MHConciergeNavViewController.h"
#import <Social/Social.h>

@interface MHConciergeNavViewController ()

@end

@implementation MHConciergeNavViewController
...
- (IBAction)shareFacebook:(id)sender {
    ...
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook]){
        ...
        [composeController setInitialText:@"MHacks is #stacked!"];
        //Post actual selfie?
...
- (IBAction)shareTwitter:(id)sender {
    ...
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        ...
        NSString *message = [NSString stringWithFormat:@"@MHacks is #stacked!"];
